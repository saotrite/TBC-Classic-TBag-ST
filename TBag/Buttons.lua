...
-- Anniversary/TBC Classic compatibility (Container API)
if not _G.GetContainerItemCooldown and _G.C_Container and type(_G.C_Container.GetContainerItemCooldown) == "function" then
  function _G.GetContainerItemCooldown(bag, slot)
    return _G.C_Container.GetContainerItemCooldown(bag, slot)
  end
end
